...
\subsection{*From QCD to an effective theory}

To construct the Lagrangian of chiral perturbation theory, or \chpt, we start with the Lagrangian of massless QCD, 
%
\begin{equation}
...
\subsection{External currents and }
