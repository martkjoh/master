...
In \autoref{appendix: rewriting terms}, we show how to rewrite the Lagrangian to match the one used in~\autocite{adhikariTwoflavorChiralPerturbation2019,mojahedTwoflavorChiralPerturbation2020}.
...
The different terms of the NLO Lagrangian are
\begingroup
\allowdisplaybreaks 
%
\begin{align}
