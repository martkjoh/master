...
\todo[]{Beskriv effective field theory, Weinberg's theorem, Ward identities, schwinger-dyson og grunnlag for chpt}

\begin{equation}
    Z[J] = \int \D \varphi \, \exp{i\int \dd^4 x \, \left( \Ell[\varphi, J] \right)}
    = \int \D \pi\, \exp{i\int \dd^4 x \, \Ell[\pi, J]}.
\end{equation}
