...
% \autoref{correlator from generating functional} 
()
\todo{fix referanse}
becomes
\begin{align*}
...
The Feynman rules for a free scalar field in thermal field theory are derived in (\todo{fix ref}{section:interacting scalar}), and the general procedure is found in any of the main sources for this section~\autocite{peskinIntroductionQuantumField1995,schwartzQuantumFieldTheory2013,weinbergQuantumTheoryFields1995,weinbergQuantumTheoryFields1996}
The source terms gives rise to an additional vertex
\todo{Draw new diagrams}
% \begin{equation}
