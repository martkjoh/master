...
\begin{equation}
    ...
    \includegraphics[width=0.25\textwidth, valign=c]{figurer/feynman-diagram/source_diagram.pdf}.
\end{equation}
...
\begin{equation}
    ...
    W_0[J] = 
    \includegraphics[valign=c, width=0.30\textwidth]{figurer/feynman-diagram/connected_free_diagram.pdf}.
\end{equation}
