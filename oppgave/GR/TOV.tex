...
With the stress-energy tensor, we may now input it into the Einstein field equation.
...
With $p(r)$, $u(r)$, and $m(r)$, we can construct the metric.
...
In addition to the dynamics of spacetime, we to know the thermodynamic properties of the matter that make up our star.
...
One important model for stars is the \emph{polytrope}, which has an equation of state of the form $p = K u^\gamma$ for some constant $K$.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.6\textwidth]{../scripts/figurer/mass_radius_relation_polytropes.pdf}
    \caption{
...
\begin{figure}[h]
    ...
    \caption{The pressureas a function of the radius, in units of $p_0$ and $r_0$. The graphs with lighter color and higher pressure at $r = 0$ corresponds to higher values of $k_1$. The values of $k_1$ are linearly spaced.}
