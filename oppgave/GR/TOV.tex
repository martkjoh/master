...
\begin{figure}
    ...
    \caption{The pressure of a star made up of a incompressible fluid, as a function of its radius. The different lines corresponds to different mass-radius relations $k_1$.}
