...
\todo{Hvor er det best å plassere faktor 3?}
%
\begin{equation}
...
Furthermore, the radius of the star should be much larger than the Schwarzschild radius, $R_s = 2 G M$.
...
\begin{equation}
    ...
    \diff{\tilde p}{\tilde r} = - \frac{k}{\tilde r^2}\tilde u \tilde m, \quad
...
%
\begin{equation}
    4 \pi \tilde r^2 \diff{\tilde p}{\tilde m}
...
This is illustrated in \autoref{fig: hydrostatic equillibrium}.
...
In the case of the TOV equation, we tacitly assumed hydrostatic equilibrium when we gave the fluid a rest frame where we could write $v_\mu = (v_0, 0, 0, 0)$ globaly.
