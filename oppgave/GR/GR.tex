...
However, first we will shortly summarize the theory it succeeded.
...
Formulating this as an equation, with $\vv r$ as the vector from the object with mass $M$ to that with mass $m$, gives
%
\begin{equation}
    \vv F_g = - \frac{G M m}{r^2} \hat r.
\end{equation}
%
Here, $G$ is Newton's gravitation constant, and $\hat r = \vv r / |\vv r|$.
