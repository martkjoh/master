...
We do, however, expect the results using constants from the Particle  k~\autocite{particledatagroupReviewParticlePhysics2020} to be more accurate to real-world physics.\todo[]{Er dette litt vel frekt?}
