...
Instead of perfectly describing all degrees of freedom and their interaction, we consider what a \emph{typical} system would look like.
...
We work in the \emph{grand canonical ensambla}, in which we consider the system coupled to a source of \emph{conserved charges}, such as electrical charge, or particle number in non-relativistic physics.
...
The pion condensed phase is only one part of the rich phase diagram of QCD, an active are of research.
...
As such, it is an imperative of basic science to extend our knowledge on this subject, and to develop a wide array of methods of investigation to crosscheck results and how the assumptions made affect them.
The dynamics of stars have always been a great inspiration and guidance for the development of physics.
...
It is believed that the core of consists of deconfined quark matter, which could be in a color superconducting phase~\autocite{baymHadronsQuarksNeutron2018,alfordColorSuperconductivityDense2008}.
\todo[inline]{skriv om muligheten for pionstjerner}


\section{Outline fo theseis}
...
This thesis aims to be on the (nivå?) of someone who has the background equivalent of a master's degree in a related part of physics, but without any specific knowledge of any of its subjects.
The first part of this thesis surveys the theoretical background needed.
\autoref{chapter: math} ummarises ...
