...
\end{equation}
%
When the energy is on the simple form $E^2 = \vv p^2 + m^2$, we can use the result from \autoref{section: regualting free energy}, 
%
\begin{equation}
...
\end{equation}
%
This integral is regulated using dimensional regularization, where $d = 3 - 2\epsilon $, and using the $\overline{\text{MS}} $-shceme, as described in \autoref{subsection: renormalization}.