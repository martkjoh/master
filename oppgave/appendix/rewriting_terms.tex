...
\section{*Rewriting NLO Lagrangian}
...
\end{align}
%
We can rewrite it to match the one used in~\autocite{adhikariTwoflavorChiralPerturbation2019,mojahedTwoflavorChiralPerturbation2020}, starting with
%
%
\begin{align*}
    & \frac{h_1 - h_3 - l_4}{16}
