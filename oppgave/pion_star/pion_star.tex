...
This is because the light electrons make the equation of state much stiffer.
Furthermore, the non-relativisitic equation of state is now a polytrope with $\gamma = \frac{5}{3}$, instead of $\gamma = 2$, and there is therefore no upper mass limit.
The maximum mass is now $146\, M_\odot $, and the corresponding maximum radius is $ 1.87\times 10^4 \,\text{km}$.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{../scripts/figurer/pion_star/mass_radius_lepton_compare.pdf}
    \caption{
        The mass-radius relation of pion stars, including leptons to enforce charge neutrality, is compared with pion stars of only pions.
        The radius is given in kilometers and the mass in units of solar masses.
        }
