...
\todo[]{Er det andre energigrenser vi må være under? i.e. resonanser, nukleoner?}
...
These are first-principle numerical methods which works directly with QCD without any assumption of symmetry breaking or the creation of an effective theory.
...
For $p<0.5$, the NLO results for the pion condensate are in excellent agreement, while the deviation increase somewhat above this.
...
\begin{figure}[H]
    ...
    \caption{
        ...
        The results of \citeauthor{brandtNewClassCompact2018}~\autocite{brandtNewClassCompact2018}, in solid color incorporating uncertainty, are compared with the leading order results obtained in this text.
...
\begin{figure}[H]
    ...
    \caption{
        ...
        The results of \citeauthor{brandtNewClassCompact2018}~\citeauthor{brandtNewClassCompact2018}, solid color incorporating uncertainty, are compared with our LO results, dashed lines.
...
\todo[]{Vet vi hva de brukte for elektroner/muoner?}
%
\begin{align}
    m_\pi &= 131\,\text{MeV},\\
    f_\pi &= 90.5\,\text{MeV},\\
