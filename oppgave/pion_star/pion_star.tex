...
\end{equation}
%
This is illustrated in~\autoref{fig: equation of state pions}.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{../scripts/figurer/pion_star/pion_eos.pdf}
    \caption{
...
\autoref{fig: mass-radius relation pion star} shows the mass-radius relationship for the pion star using the tree-level free energy density of two-flavor chiral perturbation theory.
