...
\begin{figure}[h]
    \centering
    \vspace*{4cm}
    \includegraphics[width=.95\textwidth]{../scripts/figurer/pion_star/pressure_mass_pion_star.pdf}
    \caption{
...
\citeauthor{brandtNewClassCompact2018} do not use the values of physical constants from the Particle Data Group (PDG) \autocite{zylaReviewParticlePhysics2020}, as we have used in this thesis.
...
\begin{figure}[p]
    ...
    \caption{
        The mass-radius relations, using the constants from the PDG \autocite{zylaReviewParticlePhysics2020} or as used in lattice QCD calculations \autocite{brandtNewClassCompact2018}.
