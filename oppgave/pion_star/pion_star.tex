...
Both mass-radius relations are compared to the results with only the pion in \autoref{fig: mass radius relation with leptons}.
...
\begin{table}
    \centering
    \caption{The values of various quantitites at for the maximum mass stars}
...
\todo[inline]{Add table with values at maximum mass}
