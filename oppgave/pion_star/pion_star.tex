...
Substituting this dimensionless variable into the free energy density, we get
%
\begin{equation}
...
\end{equation}
%
This is illustrated in \autoref{fig:}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{../scripts/figurer/pion_tree_eos.pdf}
    \caption{
        The tree-level equation of state of two-flavor chiral perturbation theory. The $x$-axis shows the pressure normalized to $p_0$, while the $y$-axis shows the energy density normalized to $u_0$.
        }
\end{figure}
...
We, therefore, expect both the radius and mass of the pion star to be around one order of magnitude larger than the star made up of fermions.
...
\begin{figure}[h]
    ...
    \label{fig: pressure and mass for tree pion stars}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{
        The relationship between the mass and radius of a pion star. Mass is given in units of solar masses, while the radius is measured in kilometers.
