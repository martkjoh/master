In \autoref{chapter: chpt}, we built up machinery to do calculations in chiral perturbation theory in the case of a non-zero isospin chemical potential $\mu_I$.
