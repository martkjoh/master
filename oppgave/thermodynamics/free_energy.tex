...
We define the effective chemical potential by ${\mu'}^2 = \mu^2 - \Delta_\text{EM}^2$.
...
Although the electromagnetic contribution to the \emph{square} of the mass is the same by Dashen's theorem, $\Delta m_\text{EM}^2$, the absolute shift will depend on the ration between $\Delta m_\text{EM}$ and the non-electromagnetic mass.
