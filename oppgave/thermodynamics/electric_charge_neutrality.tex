...
This is due to the long-ranged nature of the Coulomb force, which ensures that any macroscopically charged objects will neutralize each other, given that the total amount of charge is zero.
