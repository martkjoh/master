...
In this section and the two next, where we are working with leading order results only, we will not distinguish between the physical masses, such as $m_\pi$ and $m_\Kpm$, and the leading tree-level masses, such as $\bar m$ and $m_{\Kpm,0}$, as they agree to leading order.
