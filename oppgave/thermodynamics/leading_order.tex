...
In this section and the two next, we will substitute the physical masses, such as $m_\pi$, for the tree-level masses \autoref{leading order pion mass mu=0}, \autoref{leading order charged kaon mass mu=0}, \autoref{leading order neutral kaon mass mu=0}, and \autoref{leading order eta mass mu=0}, as they agree to leading order.
...
\begin{align}
    ...
    \left(
        \frac{\mu_I^2}{m_\pi^2}+ 2 + \Delta
        - \frac{3\frac{\mu_I^2}{m_\pi^2} - \Delta }{\left(\frac{\mu_I^2}{m_\pi^2} - \Delta\right)^2}
    \right).
\end{align}
%
...
\begin{equation}
    ...
    = 
    \frac{
        \frac{\mu_I^4}{m_\pi^4} - (2\Delta + 1)\frac{\mu_I^2}{m_\pi^2} + \Delta(\Delta + 1)
        }{
        \frac{\mu_I^4}{m_\pi^4} + 3\frac{\mu_I^2}{m_\pi^2} - \Delta (\Delta +1)
        }.
\end{equation}
%
